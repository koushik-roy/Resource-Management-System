...
function EditCustomerCategory() {
  ...
  const getdata = async () => {
    await axios
      .get(`http://localhost:9191/customerCategory/${params.id}`)
      .then((res) => {
  ...
  const onSubmit = (data) => {
    CustomerCategoryService.submitEditCategory(category);
  };
        ...
        <div className="group" style={{ margin: "1% auto" }}>
          ...
          >
            <div className="heading" style={{ marginTop: "33px" }}>
              <h1 className="text">Edit Customer Category</h1>
            </div>
              ...
              <div className="form-group">
                ...
                >
                  ...
                  <textarea
                    ...
                    style={{ width: "553px", marginLeft: "301px" }}
                    className={`form-control ${
                      errors.description &&
                      "focus:border-red-500 focus:ring-red-500 border-red-500"
                    } `}
