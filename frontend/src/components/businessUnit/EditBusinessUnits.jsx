...
function BusinessUnit() {
  ...
  const getdata = async () => {
    await axios
      .get(`http://localhost:9191/businessUnit/${params.id}`)
      .then((res) => {
  ...
  const onSubmit = (data) => {
    ...
    businessunitService.submitEditBusiness(business);
  };
  return (
    <>
      <Header />
        ...
        <div className="group" style={{ margin: "1% auto" }}>
          ...
          >
            <div className="heading" style={{ marginTop: "33px" }}>
              <h1 className="text">Edit Business Unit</h1>
            </div>
            <form
              name="myForm"
              className="form"
            ...
            >
              ...
              <div className="form-group" >
                <label htmlFor="unit_description" style={{ marginLeft: "-29rem" }}>Unit Description</label>
                <textarea
                  type="text"
                  style={{ width: "553px", marginLeft: "15px" }}
                  value={business.unit_description}
